...
execute on vehicle if entity @s[type=minecraft:oak_chest_boat,tag=ajjgui.gui_boat] run function ajjgui:gui/ported/close
...
execute as @e[type=minecraft:marker,tag=ajjgui.gui_ported,tag=ajjgui.gui_new] run function ajjgui:gui/ported/load with storage ajjgui:data temp
execute as @e[type=minecraft:marker,tag=ajjgui.gui_ported,tag=ajjgui.gui_new] at @s run function ajjgui:gui/ported/load_page
