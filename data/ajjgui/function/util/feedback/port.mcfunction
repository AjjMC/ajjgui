...
execute if data storage ajjgui:data settings.feedback{target:"@s"} run tellraw @s {"text":"Ported GUI\n"}
execute if data storage ajjgui:data settings.feedback{target:"@a"} run tellraw @a {"text":"Ported GUI\n"}
