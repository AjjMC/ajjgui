...
give @s minecraft:shulker_box[minecraft:custom_data={ajjgui:{kit:1b}},minecraft:custom_name={text:"GUI Page",italic:0b},minecraft:lore=[{text:"Insert the widgets here",italic:0b},{text:""},{text:"You can obtain some premade widgets by running:",italic:0b},{text:""},{text:"/function ajjgui:__widget/",color:"green",italic:0b}]]
