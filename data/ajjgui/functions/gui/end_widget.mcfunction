...
execute store result score @s ajjgui.page run scoreboard players get @e[type=minecraft:armor_stand,tag=ajjgui.gui,tag=ajjgui.active_gui,limit=1] ajjgui.page