execute unless entity @e[type=minecraft:marker,tag=ajjgui.cmd1] run tellraw @a [{"text":"ajjgui","color":"gray"},{"text":" is not installed","color":"red"}]
...
execute if entity @e[type=minecraft:marker,tag=ajjgui.cmd1] if score #temp ajjgui.temp matches 1 at @e[type=minecraft:marker,tag=ajjgui.cmd1] run function ajjgui:gui/install_success
execute if entity @e[type=minecraft:marker,tag=ajjgui.cmd1] if score #temp ajjgui.temp matches 1 run tellraw @a [{"text":"\nUpdated "},{"text":"ajjgui","color":"gray"},{"text":" to version "},{"nbt":"Version","storage":"ajjgui:gui","color":"gray"}]
